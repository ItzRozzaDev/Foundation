...
public final class ItemUtil {
	 ...
	 * @return
	 */
	public static String bountifyCapitalized(final CompChatColor color) {
	 ...
	 * @return
	 */
	public static String bountifyCapitalized(final Enum<?> enumeration) {
	 ...
	 * @return
	 */
	public static String bountifyCapitalized(final String name) {
	 ...
	 * @return
	 */
	public static String bountify(final Enum<?> enumeration) {
	 ...
	 * @return
	 */
	public static String bountify(final String name) {
	 ...
	 * @return
	 */
	public static String bountify(final PotionEffectType enumeration) {
	 ...
	 * @return
	 */
	public static String bountify(final Enchantment enchant) {
	...
	public static boolean isSimilar(final ItemStack first, final ItemStack second) {
		...
		final boolean dataMatch = !LEGACY_MATERIALS || first.getData().getData() == second.getData().getData();
	...
	private static boolean matchNbt(final String key, final NBTItem firstNbt, final NBTItem secondNbt) {
...
enum PotionWrapper {
	...
	private PotionWrapper(final String bukkitName) {
		this(bukkitName, null);
	}

	protected static String getLocalizedName(final String name) {

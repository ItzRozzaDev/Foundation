...
public final class TimeUtil {
	...
	private static final DateFormat DATE_FORMAT_SLASH = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss");
	private static final DateFormat DATE_FORMAT_SLASH_AMERICAN = new SimpleDateFormat("MM/dd/yyyy HH:mm:ss");
	...
	public static String getFormattedDateSlash(final long time) {
		return DATE_FORMAT_SLASH.format(time);
	}

	public static String getFormattedDateSlashAmerican(final long time) {
		return DATE_FORMAT_SLASH_AMERICAN.format(time);
	}
	...
	public static String customTimeFormat(final String dateFormat, final long time) {
		final DateFormat CUSTOM_DATE_FORMAT = new SimpleDateFormat(dateFormat);
		return CUSTOM_DATE_FORMAT.format(time);
	}
	 ...
	 * @return
	 */
	public static long parseToken(final String text) {

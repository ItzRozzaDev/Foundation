package com.itzrozzadev.fo.debug;
...
public final class LagCatcher {
	 ...
	 * @param rapid
	 */
	public static void end(final String section, final boolean rapid) {
	 ...
	 * @param code
	 */
	public static void performanceTest(final int cycles, final String name, final Runnable code) {
	 ...
	 * @param section
	 */
	public static void performancePartStart(final String section) {
	 ...
	 * @param section
	 */
	public static void performancePartSnap(final String section) {
	 ...
	 * @return
	 */
	public static void took(final String section) {

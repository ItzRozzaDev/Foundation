...
import com.itzrozzadev.fo.conversation.SimpleDecimalPrompt;
...
public abstract class Button {
	 ...
	 * @return the button
	 */
	public static DummyButton makeDummy(final ItemCreator.ItemCreatorBuilder builder) {
	 ...
	 * @return the button
	 */
	public static DummyButton makeDummy(final ItemCreator creator) {
		return new DummyButton(creator.makeMenuTool());
	}

	public static DummyButton makeDummy(final ItemStack item) {
	 ...
	 * @return
	 */
	public static Button makeSimple(final CompMaterial icon, final String title, final String label, final Consumer<Player> onClickFunction) {
		return new Button() {
	 ...
	 * @return
	 */
	public static Button makeSimple(final ItemCreator.ItemCreatorBuilder builder, final Consumer<Player> onClickFunction) {
		return new Button() {
	 ...
	 * @return
	 */
	public static Button makeSimple(final CompMaterial icon, final String title, final String label, final BiConsumer<Player, ClickType> onClickFunction) {
		return new Button() {

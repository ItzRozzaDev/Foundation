...
public final class ChatImage {
	 ...
	 * @return
	 */
	public ChatImage appendText(final String... text) {
	 ...
	 * @return
	 */
	public ChatImage appendCenteredText(final String... text) {
		for (int y = 0; y < lines.length; y++)
			if (text.length > y) {
	 ...
	 */
	private String center(final String message, final int length) {
	 ...
	 * @param sender
	 */
	public void sendToPlayer(final CommandSender sender) {
	 ...
	 * @return
	 */
	public static ChatImage fromFile(@NonNull final File file, final int height, final Type characterType) throws IOException {
	 ...
	 * @return
	 */
	public static ChatImage fromLines(final String[] lines) {
		final ChatImage chatImage = new ChatImage();
	 ...
	 */
	private static CompChatColor[][] parseImage(final BufferedImage image, final int height) {
	 ...
	 */
	private static CompChatColor getClosestChatColor(final Color color) {
	 ...
	 */
	private static String[] parseColors(final CompChatColor[][] colors, final Type imgchar) {

...
public final class SimpleComponent implements ConfigSerializable {
	 ...
	 * @return
	 */
	private static TextComponent[] toComponent(@NonNull String message, @Nullable final BaseComponent inheritFormatting) {
	...
	static final class Part implements ConfigSerializable {
		 ...
		 */
		@Nullable
		private TextComponent toTextComponent(final CommandSender receiver) {
		 ...
		 */
		private boolean canSendTo(@Nullable final CommandSender receiver) {

...
public final class Variable extends YamlConfig {
	...
	/**
	 * @see com.itzrozzadev.fo.settings.YamlConfig#onLoadFinish()
	 */
	@Override
	 ...
	 * @return
	 */
	public String getValue(final CommandSender sender, @Nullable final Map<String, Object> replacements) {
	 ...
	 * @return
	 */
	public SimpleComponent build(final CommandSender sender, final SimpleComponent existingComponent, @Nullable final Map<String, Object> replacements) {
	...
	/**
	 * @see com.itzrozzadev.fo.settings.YamlConfig#toString()
	 */
	@Override

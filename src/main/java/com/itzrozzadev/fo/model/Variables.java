...
import com.itzrozzadev.fo.GeoAPI.GeoResponse;
...
public final class Variables {
	 ...
	 */
	@Nullable
	public static Function<CommandSender, String> getVariable(final String key) {
	 ...
	 * @param replacer
	 */
	public static void addVariable(final String variable, final Function<CommandSender, String> replacer) {
	 ...
	 * @param variable
	 */
	public static void removeVariable(final String variable) {
	 ...
	 * @return
	 */
	public static boolean hasVariable(final String variable) {
	 ...
	 * @param expansion
	 */
	public static void removeExpansion(final SimpleExpansion expansion) {
	 ...
	 * @return
	 */
	public static boolean hasExpansion(final SimpleExpansion expansion) {
	 ...
	 */
	@Deprecated
	public static String replace(final boolean replaceCustom, final String message, final CommandSender sender) {
	 ...
	 * @return
	 */
	public static List<String> replace(final Iterable<String> messages, @Nullable final CommandSender sender, @Nullable final Map<String, Object> replacements) {
	 ...
	 * @return
	 */
	public static String replace(final String message, @Nullable final CommandSender sender) {
	 ...
	 * @return
	 */
	public static String replace(final String message, @Nullable final CommandSender sender, @Nullable final Map<String, Object> replacements) {
	 ...
	 * @return
	 */
	public static String replace(String message, @Nullable final CommandSender sender, @Nullable final Map<String, Object> replacements, final boolean colorize) {
	 ...
	 */
	private static String replaceJavascriptVariables0(String message, final CommandSender sender, @Nullable final Map<String, Object> replacements) {
	 ...
	 */
	private static String replaceHardVariables0(@Nullable final CommandSender sender, String message) {
	 ...
	 */
	private static String lookupVariable0(final Player player, final CommandSender console, final String variable) {
	 ...
	 */
	private static String formatHealth0(final Player player) {
	 ...
	 */
	private static String formatIp0(final Player player) {
		try {

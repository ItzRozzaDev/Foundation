...
import com.itzrozzadev.fo.menu.MenuListener;
import com.itzrozzadev.fo.menu.tool.Rocket;
import com.itzrozzadev.fo.menu.tool.Tool;
import com.itzrozzadev.fo.menu.tool.ToolsListener;
import com.itzrozzadev.fo.metrics.Metrics;
...
import com.itzrozzadev.fo.settings.YamlConfig;
import com.itzrozzadev.fo.settings.YamlStaticConfig;
import com.itzrozzadev.fo.visual.BlockVisualizer;
...
public abstract class SimplePlugin extends JavaPlugin implements Listener {
	...
	private final boolean checkServerVersions0() {
		...
		// Check max version
		final MinecraftVersion.V maximumVersion = getMaximumVersion();

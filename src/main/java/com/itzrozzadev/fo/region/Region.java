package com.itzrozzadev.fo.region;
...
import com.itzrozzadev.fo.visual.VisualizedRegion;
...
public class Region implements ConfigSerializable {
	...
	public final boolean isWithinIgnoreY(@NonNull final Location location) {
		Valid.checkBoolean(isWhole(), "Cannot perform isWithin on a non-complete region: " + toString());

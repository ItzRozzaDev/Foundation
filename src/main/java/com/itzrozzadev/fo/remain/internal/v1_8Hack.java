...
class v1_8Hack extends EnderDragonEntity {
	...
	public v1_8Hack(final String name, final Location loc) {
		super(name, loc);
	}
	...
	public Object getSpawnPacket() {
		...
		Object packet = null;
		try {
			this.dragon = EntityEnderDragon.getConstructor(ReflectionUtil.getNMSClass("World", "N/A")).newInstance(getWorld());
			...
			setLocation.invoke(this.dragon, getX(), getY(), getZ(), getPitch(), getYaw());

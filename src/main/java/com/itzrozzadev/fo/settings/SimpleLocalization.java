...
public abstract class SimpleLocalization extends YamlStaticConfig {
	...
	public static final class Commands {
		 ...
		 */
		public static String LABEL_SUBCOMMAND_DESCRIPTION = " &8&l» {label} {sublabel} {usage+}{dash+}{description}";
		...
		public static String RELOAD_FAIL = "&4ERROR, &creloading failed! See the console for more information. Error: {error}";

		/**
		 * The message shown when there is a fatal error running this command
		 */
		public static String ERROR = "&4&lERROR! &cThe command failed please look in console.";

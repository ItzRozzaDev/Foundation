...
public final class SimpleYaml extends FileConfiguration {
	...
	public String saveToString(final Map<String, Object> values) {
	 ...
	 */
	@NotNull
	public static SimpleYaml loadConfiguration(@NotNull final File file) {
	 ...
	 */
	@NotNull
	public static SimpleYaml loadConfiguration(@NotNull final Reader reader) {

...
public class YamlConfig {
	...
	/**
	 * If  is on, what sections should we ignore from
	...
	protected final <T extends Enum<T>> List<T> getCompatibleEnumList(final String path, final Class<T> type) {
		...
		if (enumNames != null)
			for (final String enumName : enumNames) {
				...
				} catch (final IllegalArgumentException | ReflectionUtil.MissingEnumException ex) {
...
final class ConfigInstance {
	...
	/**
	 * If  is on, we'll ignore these sections
